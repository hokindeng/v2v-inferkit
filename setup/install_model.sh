...
#
# Ported from VBVR-InferKit setup/install_model.sh with one change: a model
# directory may ship a setup.sh (repo clones, multi-part checkpoints, custom
# pip steps) — when present it is used instead of the bare requirements.txt
# venv flow.
#
# Usage:
